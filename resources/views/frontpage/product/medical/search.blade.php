      ...
      <div class="block block-system">
         <div class="content">
            <div class="view view-danh-sach-dich-vu-1 view-id-danh_sach_dich_vu_1 view-display-id-page_2 view-dom-id-022b05a9d049ad1ede4ac9b5b7cfe8cb">
               <h1 id="page-title">Tìm kiếm phòng thí nghiệm y tế</h1>
               <div class="view-filters" id="views-fieldset">
                  <form action="/" method="get" id="views-exposed-form-danh-sach-dich-vu-1-page-5" accept-charset="UTF-8">
                      <div>
                          <div class="views-exposed-form">
                              <div class="views-exposed-widgets clearfix">
                                  ...
                                  <div id="edit-field-dichvu-vilas-med-value-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_vilas_med_value">
                                      <label for="edit-field-dichvu-vilas-med-value">
                                          Số VILAS MED </label>
                                      <div class="views-widget">
                                  ...
                                  <div id="edit-title-wrapper" class="views-exposed-widget views-widget-filter-title">
                                      <label for="edit-title">
                                          Tên phòng y tế </label>
                                      <div class="views-widget">
                                          <div class="form-item form-type-textfield form-item-title">
                                              <input type="text" id="edit-title" name="title" value="" size="30" maxlength="128" class="form-text" placeholder="Tên phòng thí nghiệm y tế">
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div id="edit-field-dichvu-linhvuc-tid-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_linhvuc_tid">
                                      ...
                                      <div class="views-widget">
                                          ...
                                          <option value="" disabled selected>Lĩnh vực</option>
                                                ...
                                                <option value="301">-Huyết học</option>
                                                  <option value="299">-Hoá sinh</option>
                                                  <option value="304">-Giải phẫu bệnh</option>
                                                  <option value="298">-Vi sinh</option>
                                                  <option value="302">-Truyền máu</option>
                                                  <option value="305">-Xét nghiệm miễn dịch - sàng lọc máu</option>
                                                  <option value="303">-Đông máu</option>
                                              </select>
                                          </div>
                                      </div>
                                  </div>
