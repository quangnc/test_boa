...
<div id="main-content">
   ...
   <div class="region region-content">
        <div id="block-system-main" class="block block-system">
           <div class="content">
              <div class="view view-danh-sach-dich-vu-1 view-id-danh_sach_dich_vu_1 view-display-id-page_8 view-dom-id-0b16c904150e48786ed6ed3a758bdc17">
                 <h1 class="uk-display-inline-block">Danh sách phòng chứng nhận</h1>
                 <div class="view-filters" id="views-fieldset">
                    <form action="/vi/chung-nhan" method="get" id="views-exposed-form-danh-sach-dich-vu-1-page-8" accept-charset="UTF-8">
                       <div>
                                ...
                                <div id="edit-field-dichvu-vias-value-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_vias_value">
                                   ...
                                   <div class="views-widget">
                                      <div class="form-item form-type-textfield form-item-field-dichvu-vias-value">
                                         <input type="text" id="edit-field-dichvu-vias-value" name="field_dichvu_vias_value" value="" size="30" maxlength="128" class="form-text" placeholder="Số VACICAS">
                                      </div>
                                   </div>
                                </div>
