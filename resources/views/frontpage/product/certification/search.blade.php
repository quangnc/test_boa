      ...
      <div  class="block block-system">
         <div class="content">
            <div class="view view-danh-sach-dich-vu-1 view-id-danh_sach_dich_vu_1 view-display-id-page_2 view-dom-id-022b05a9d049ad1ede4ac9b5b7cfe8cb">
               <h1 id="page-title">Tìm kiếm tổ chức chứng nhận</h1>
               <div class="view-filters" id="views-fieldset">
                  <form action="/" method="get" id="views-exposed-form-danh-sach-dich-vu-1-page-4" accept-charset="UTF-8">
                      <div>
                          <div class="views-exposed-form">
                              <div class="views-exposed-widgets clearfix">
                                  ...
                                  <div id="edit-field-dichvu-vicas-value-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_vicas_value">
                                      <label for="edit-field-dichvu-vicas-value">
                                          Số VACICAS </label>
                                      <div class="views-widget">
                                          <div class="form-item form-type-textfield form-item-field-dichvu-vicas-value">
                                              <input type="text" id="edit-field-dichvu-vicas-value" name="field_dichvu_vicas_value" value="" size="30" maxlength="128" class="form-text" placeholder="Số VACICAS">
                                          </div>
                                      </div>
                                  </div>
                                  <div id="edit-title-wrapper" class="views-exposed-widget views-widget-filter-title">
                                      <label for="edit-title">
                                          Tên phòng chứng nhận </label>
                                      <div class="views-widget">
                                          <div class="form-item form-type-textfield form-item-title">
                                              <input type="text" id="edit-title" name="title" value="" size="30" maxlength="128" class="form-text" placeholder="Tên tổ chức chứng nhận">
                                          </div>
                                      </div>
                                  </div>
                                  <div id="edit-field-dichvu-khuvuc-tid-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_khuvuc_tid">
                                      ...
                                      <div class="views-widget">
                                          <div class="form-item form-type-select form-item-field-dichvu-khuvuc-tid">
                                              <select multiple="multiple" name="field_dichvu_khuvuc_tid[]" id="edit-field-dichvu-khuvuc-tid" size="9" class="form-select ui-multiselect-processed">
                                  ...
                                  <div id="edit-field-dichvu-linhvuc-tid-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_linhvuc_tid">
                                      <label for="edit-field-dichvu-linhvuc-tid">
                                          Lĩnh vực </label>
                                      <div class="views-widget">
                                          <div class="form-item form-type-select form-item-field-dichvu-linhvuc-tid">
                                              <select multiple="multiple" name="field_dichvu_linhvuc_tid[]" id="edit-field-dichvu-linhvuc-tid" size="7" class="form-select ui-multiselect-processed" style="display: none;">
                                                  <option value="" disabled selected>Lĩnh vực</option>
                                                  <option value="187">-Hệ thống quản lý chất lượng</option>
                                                  <option value="189">-Hệ thống quản lý môi trường</option>
                                                  <option value="191">-Hệ thống quản lý an toàn thực phẩm</option>
                                                  <option value="193">-Chứng nhận sản phẩm</option>
                                                  <option value="335">-Năng lực cá nhân</option>
                                                  <option value="324">-GMP</option>
                                                  <option value="325">-Global GAP</option>
                                              </select>
                                          </div>
                                      </div>
                                  </div>
              
                                  <div id="edit-field-dichvu-diadiem-value-wrapper" class="views-exposed-widget views-widget-filter-field_dichvu_diadiem_value">
                                      <label for="edit-field-dichvu-diadiem-value">
                                          Địa điểm công nhận </label>
                                      <div class="views-widget">
                                          <div class="form-item form-type-textfield form-item-field-dichvu-diadiem-value">
                                              <input placeholder="Địa điểm công nhận..." type="text" id="edit-field-dichvu-diadiem-value" name="field_dichvu_diadiem_value" value="" size="30" maxlength="128" class="form-text">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="views-exposed-widget views-submit-button">
                                      <input type="submit" id="edit-submit-danh-sach-dich-vu-1" name="" value="Tìm kiếm" class="form-submit"> </div>
                              </div>
                          </div>
                      </div>
                  </form>
