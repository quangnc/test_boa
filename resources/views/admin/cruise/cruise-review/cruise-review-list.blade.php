        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    @isset($cruise_reviews)
                        @foreach ($cruise_reviews as $review)
                            <tr>
                                ...
                                <td class="text-right">
                                    <form id="delete-{{$review->review_id}}" action="{{ route('cruise-review.destroy', ['id'=>$review->review_id]) }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <a style="margin-right: 5px" href="{{ route('cruise-review.edit', ['id'=>$review->review_id]) }}"
