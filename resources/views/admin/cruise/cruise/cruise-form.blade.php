        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ $data['action'] }}" method="POST" id="{{ $data['form'] }}">
                    {{ csrf_field() }}
                    @if ($data['action'] != route( 'cruise.index' )) 
                    ...
                    <div class="tab-content" style="padding-top: 20px">
                        <div class="tab-pane active" id="general">
                            @include('admin.cruise.cruise.components.general')
                        </div>
                        <div class="tab-pane" id="special">
                            @include('admin.cruise.cruise.components.special')
                        </div>
                        <div class="tab-pane" id="data">
                            @include('admin.cruise.cruise.components.data')
                        </div>
                        <div class="tab-pane" id="image">
                            @include('admin.cruise.cruise.components.image')
                        </div>
                    </div>
                </form>
            </div>
