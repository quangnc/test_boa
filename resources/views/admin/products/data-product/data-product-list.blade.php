                    ...
                    @isset($data['blog_post'])
                        @foreach ($data['blog_post'] as $blog_post)
                            <tr>
                                ...
                                <td class="text-right">
                                    <form id="delete-{{$blog_post['id']}}" action="{{ route('data-product.destroy', ['id'=>$blog_post['id']]) }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <a style="margin-right: 5px" href="{{ route('data-product.edit', ['id'=>$blog_post['id']]) }}"
