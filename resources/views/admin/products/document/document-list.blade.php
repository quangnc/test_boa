                    ...
                    @isset($data['blog_post'])
                        @foreach ($data['blog_post'] as $blog_post)
                            <tr>
                                ...
                                <td class="text-right">
                                    <form id="delete-{{$blog_post['id']}}" action="{{ route('document.destroy', ['id'=>$blog_post['id']]) }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <a style="margin-right: 5px" href="{{ route('document.edit', ['id'=>$blog_post['id']]) }}"
