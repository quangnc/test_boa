                    ...
                    @isset($reviews)
                        @foreach ($reviews as $review)
                            <tr>
                                ...
                                <td class="text-right">
                                    <form id="delete-{{$review->review_id}}" action="{{ route('review.destroy', ['id'=>$review->review_id]) }}" method="post">
                                        {{ csrf_field() }}
                                    ...
                                    <a style="margin-right: 5px" href="{{ route('review.edit', ['id'=>$review->review_id]) }}"
