                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Title"
                                    name="blog_post_descriptions[{{ $language->language_id }}][title]"
                                    value="{{ isset($blog_post_descriptions[$language->language_id]['title']) ? $blog_post_descriptions[$language->language_id]['title'] : old("blog_post_descriptions.".$language->language_id.".title") }}"
                            >
                            @if($errors->has(`blog_post_descriptions.$language->language_id.title`) && !old("blog_post_descriptions.".$language->language_id.".title"))
                                <p style="color:red">{{$errors->first(`blog_post_descriptions[$language->language_id][title]`) }}</p>
                            @endif
                        </div>
                    </div>
                </div>
