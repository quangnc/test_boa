        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ $data['action'] }}" method="POST" id="{{ $data['form'] }}">
                    ...
                    <div class="row" style="margin-bottom: 20px">
                        <label class="col-2 text-right" for="input-name">Module Html</label>
                        <div class="col-10">
                            <textarea class="form-control" rows="10" name="module[html]">{{ isset($data['html']) ? $data['html'] : '' }}</textarea>
                        </div>
                    </div>
