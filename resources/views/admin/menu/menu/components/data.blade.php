...
<div class="card card-primary">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="blog_post[cate_menu_id]">
                @isset($blog_post_categories)
                @foreach($blog_post_categories as $blog_post_category)
                    <option 
                        value="{{ $blog_post_category->cate_menu_id }}" 
                        {{ isset($blog_post) && $blog_post->cate_menu_id == $blog_post_category->cate_menu_id ? "selected" : ""  }}
                    >
