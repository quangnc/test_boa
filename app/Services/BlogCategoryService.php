...
// gọi đến Repository
use App\Repositories\Read\BlogCategoryRepository as Read;
use App\Repositories\Write\BlogCategoryRepository as Write;

class BlogCategoryService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
