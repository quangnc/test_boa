...
// gọi đến Repository
use App\Repositories\Read\RoomBedTypeRepository as Read;
use App\Repositories\Write\RoomBedTypeRepository as Write;

class RoomBedTypeService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
