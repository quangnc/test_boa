...
// gọi đến Repository
use App\Repositories\Read\TourDurationRepository as Read;
use App\Repositories\Write\TourDurationRepository as Write;

class TourDurationService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
