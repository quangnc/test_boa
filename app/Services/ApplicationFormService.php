...
// gọi đến Repository
use App\Repositories\Read\ApplicationFormRepository as Read;
use App\Repositories\Write\ApplicationFormRepository as Write;

class ApplicationFormService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
