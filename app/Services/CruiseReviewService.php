...
// gọi đến Repository
use App\Repositories\Read\CruiseReviewRepository as Read;
use App\Repositories\Write\CruiseReviewRepository as Write;

class CruiseReviewService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
