...
// gọi đến Repository
use App\Repositories\Read\TourReviewRepository as Read;
use App\Repositories\Write\TourReviewRepository as Write;

class TourReviewService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
