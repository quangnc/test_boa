...
// gọi đến Repository
use App\Repositories\Read\DestinationRepository as Read;
use App\Repositories\Write\DestinationRepository as Write;

class DestinationService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
