...
// gọi đến Repository
use App\Repositories\Read\DocumentRepository as Read;
use App\Repositories\Write\DocumentRepository as Write;

class DocumentService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
