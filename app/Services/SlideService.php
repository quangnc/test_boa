...
// gọi đến Repository
use App\Repositories\Read\SlideRepository as Read;
use App\Repositories\Write\SlideRepository as Write;

class SlideService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
