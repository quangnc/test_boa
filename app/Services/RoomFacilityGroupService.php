...
// gọi đến Repository
use App\Repositories\Read\RoomFacilityGroupRepository as Read;
use App\Repositories\Write\RoomFacilityGroupRepository as Write;

class RoomFacilityGroupService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
