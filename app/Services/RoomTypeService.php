...
// gọi đến Repository
use App\Repositories\Read\RoomTypeRepository as Read;
use App\Repositories\Write\RoomTypeRepository as Write;

class RoomTypeService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
