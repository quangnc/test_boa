...
// gọi đến Repository
use App\Repositories\Read\CateMenuRepository as Read;
use App\Repositories\Write\CateMenuRepository as Write;

class CateMenuService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
