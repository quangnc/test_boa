...
// gọi đến Repository
use App\Repositories\Read\UploadFileRepository as Read;
use App\Repositories\Write\UploadFileRepository as Write;

class UploadFileService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
