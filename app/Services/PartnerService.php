...
// gọi đến Repository
use App\Repositories\Read\PartnerRepository as Read;
use App\Repositories\Write\PartnerRepository as Write;

class PartnerService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
