...
// gọi đến Repository
use App\Repositories\Read\DataProductRepository as Read;
use App\Repositories\Write\DataProductRepository as Write;

class DataProductService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
