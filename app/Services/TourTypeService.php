...
// gọi đến Repository
use App\Repositories\Read\TourTypeRepository as Read;
use App\Repositories\Write\TourTypeRepository as Write;

class TourTypeService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
