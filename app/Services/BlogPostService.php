...
// gọi đến Repository
use App\Repositories\Read\BlogPostRepository as Read;
use App\Repositories\Write\BlogPostRepository as Write;

class BlogPostService implements CRUDServiceInterface
{
    protected $_read;
    protected $_write;
