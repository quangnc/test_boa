...
//        $this->middleware('auth');
    ...
    public function introduction()
    {
        ...
        return view('frontpage.product.phong-thi-nghiem.introduction', compact('data'));
    }
    ...
    public function index()
    {
        ...
        return view('frontpage.product.phong-thi-nghiem.gia-han', compact( 'data'));
    }
    ...
    public function search() {
        ...
        // 1. y tế
        // product_id
        $dataProducts = DataProduct::where('product_id', 1)->with(['data_product_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
    ...
    public function applicationForm() {
        ...
        // 1. y tế
        // product_id
        $applicationForm = ApplicationForm::where('product_id', 1)->with(['application_form_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
    ...
    public function document() {
        ...
        // 1. y tế
        // product_id
        $documents = Document::where('product_id', 1)->with(['document_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
        }])->orderBy('created_at', 'desc')->get();
        //new  7
        $blogs = BlogPost::with('blog_post_descriptions', 'blog_categories' )->get();
