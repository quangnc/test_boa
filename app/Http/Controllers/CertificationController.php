...
//        $this->middleware('auth');
    ...
    public function introduction()
    {
        ...
        return view('frontpage.product.certification.introduction', compact('data'));
    }

    public function index()
    {
        $data['pageClass'] = "html not-front not-logged-in no-sidebars page-chung-nhan i18n-vi adminimal-theme page-views page-views page-views jquery-once-1-processed mq-desktop";
        $blogs = BlogPost::with('blog_post_descriptions', 'blog_categories')->get();
        ...
        return view('frontpage.product.certification.search', compact('data'));
    }
    ...
    public function detail( $id ) 
	{
        ...
        return view('frontpage.product.certification.detail', compact( 'blog', 'blog_description', 'data' ));
    }
    ...
    public function search() {
        ...
        // 1. y tế
        // product_id
        $dataProducts = DataProduct::where('product_id', 4)->with(['data_product_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
    ...
    public function applicationForm() {
        ...
        // 1. y tế
        // product_id
        $applicationForm = ApplicationForm::where('product_id', 4)->with(['application_form_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
    ...
    public function document() {
        ...
        // 1. y tế
        // product_id
        $documents = Document::where('product_id', 4)->with(['document_descriptions' => function ($query) {
            $query->where('language_id', config('app.language', $this->adminLanguage()));
        }])->orderBy('created_at', 'desc')->get();
        //new  7
        $blogs = BlogPost::with('blog_post_descriptions', 'blog_categories' )->get();
