...
//        $this->middleware('auth');
    ...
    {
        $data['pageClass'] = "html not-front not-logged-in no-sidebars page-ds-giam-dinh i18n-vi adminimal-theme page-views page-views page-views jquery-once-1-processed mq-desktop";
        //new  7
        $blogs = BlogPost::with('blog_post_descriptions', 'blog_categories')->get();
