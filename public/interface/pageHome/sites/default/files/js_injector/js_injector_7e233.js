...
//   var newValue = $(".dichvu-chitiet .file_phamvi")
//     .text()
//     .replace('","', "");
//   $(".dichvu-chitiet .file_phamvi").text(newValue);
//   $(".i18n-vi #edit-field-dangky-diachicoquanchuquan-und-0-value").attr(
//     "placeholder",
//     "Địa chỉ"
//   );
//   $(".i18n-vi #edit-field-dangky-loaidichvu .description").text(
//     "*Vui lòng tải phụ lục bên dưới"
//   );
//   $(".i18n-en #dang-ky-node-form .form-actions #edit-submit").val("Register");
//   $(
//     ".i18n-en #edit-field-dangky-dauilac-und .form-item-field-dangky-dauilac-und-0 label"
//   ).text("No");
//   $(
//     ".i18n-en #edit-field-dangky-dauilac-und .form-item-field-dangky-dauilac-und-1 label"
//   ).text("Yes");
//   $(".i18n-en #edit-field-dangky-loaidichvu select option[value=_none]").text(
//     "--- Options ---"
//   );
//   $(".i18n-vi #edit-field-dangky-loaidichvu select option[value=_none]").html(
//     "--- Chọn loại đăng ký ---"
//   );
//   //$('#block-locale-language ul li.first').insertAfter($('#block-locale-language ul li.last'));
//   $(
//     "#block-views-exp-taxonomy-tin-tuc-page-1 #edit-submit-taxonomy-tin-tuc"
//   ).val("Tìm");
//   $("#block-search-form h2").html(
//     '<i class="uk-icon-search-plus"><i> Tìm kiếm'
//   );
//   $("#block-views-exp-taxonomy-tin-tuc-page-1 #edit-combine").attr(
//     "placeholder",
//     "Tìm kiếm theo từ khóa"
//   );
//   $(".i18n-en .ten_cty").text("BUREAU OF ACCREDITATION");
//   $(".i18n-en .breadcrumb > a:first").text("Home");
//   $(".i18n-en #block-views-exp-taxonomy-tin-tuc-page-1 h2").html(
//     '<i class="uk-icon-search-plus"><i> Search'
//   );
//   $(
//     ".i18n-en #block-views-exp-taxonomy-tin-tuc-page-1 #edit-submit-taxonomy-tin-tuc"
//   ).val("Search");
...
//   $("#edit-combine-wrapper").insertBefore(
//     $("#edit-field-dichvu-vilas-value-wrapper")
//   );
//   $("#edit-combine-wrapper").insertBefore(
//     $("#edit-field-dichvu-vias-value-wrapper")
//   );
//   $("#edit-combine-wrapper").insertBefore(
//     $("#edit-field-dichvu-vicas-value-wrapper")
//   );
//   $("#edit-combine-wrapper").insertBefore(
//     $("#edit-field-dichvu-vilas-med-value-wrapper")
//   );
...
//   $(".view-danh-sach-dich-vu-1 .form-item-combine input").attr(
//     "placeholder",
//     "Từ khóa"
//   );
// //   $(".view-danh-sach-dich-vu-1 .form-item-field-dichvu-vilas-value input").attr(
// //     "placeholder",
// //     "Số VILAS"
// //   );
//   $(".view-danh-sach-dich-vu-1 .form-item-title input").attr(
//     "placeholder",
//     "Tên phòng"
//   );
//   $(
//     ".view-danh-sach-dich-vu-1 #views-exposed-form-danh-sach-dich-vu-1-page-2 .form-item-title input"
//   ).attr("placeholder", "Tên phòng thí nghiệm");
//   $(
//     ".view-danh-sach-dich-vu-1 #views-exposed-form-danh-sach-dich-vu-1-page-4 .form-item-title input"
//   ).attr("placeholder", "Tên tổ chức chứng nhận");
//   $(
//     ".view-danh-sach-dich-vu-1 #views-exposed-form-danh-sach-dich-vu-1-page-3 .form-item-title input"
//   ).attr("placeholder", "Tên tổ chức giám định");
//   $(
//     ".view-danh-sach-dich-vu-1 #views-exposed-form-danh-sach-dich-vu-1-page-5 .form-item-title input"
//   ).attr("placeholder", "Tên phòng thí nghiệm y tế");
//   $(
//     ".view-danh-sach-dich-vu-1 .form-item-field-dichvu-chuquan-value input"
//   ).attr("placeholder", "Đơn vị chủ quản");
//   $(
//     ".view-danh-sach-dich-vu-1 .chosen-container-single .chosen-single span"
//   ).text("- Tỉnh/Thành phố -");
//   $(
//     '.view-danh-sach-dich-vu-1 select#edit-field-dichvu-linhvuc-tid option[value="All"]'
//   ).attr("- Lĩnh vực -");
//   $(".view-danh-sach-dich-vu-1 .form-item-combine input").attr(
//     "placeholder",
//     "Từ khóa"
//   );
//   $(".page-tim-kiem-thi-nghiem.i18n-en #page-title").text(
//     "SEARCH LABORATORIES"
//   );
//   $(".page-tim-kiem-chung-nhan.i18n-en #page-title").text(
//     "SEARCH CERTIFICATION BODIES"
//   );
//   $(".page-tim-kiem-giam-dinh.i18n-en #page-title").text(
//     "SEARCH INSPECTION BODIES"
//   );
//   $(".page-tim-kiem-y-te.i18n-en #page-title").text(
//     "SEARCH MEDICAL LABORATORIES"
//   );
//   // $('.i18n-en .view-danh-sach-dich-vu-1 .form-item-combine input').attr('placeholder','Key word');
// //   $(
// //     ".i18n-en .view-danh-sach-dich-vu-1 .form-item-field-dichvu-vilas-value input"
// //   ).attr("placeholder", " Vilas");
//   $(".i18n-en .view-danh-sach-dich-vu-1 .form-item-title input").attr(
//     "placeholder",
//     "Name of Laboratories"
//   );
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 .form-item-field-dichvu-chuquan-value input"
//   ).attr("placeholder", "Organization");
//   $(".i18n-en #edit-submit-danh-sach-dich-vu-1").val("Search");
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 .chosen-container-single .chosen-single span"
//   ).text("- Town / City -");
//   $(
//     '.i18n-en .view-danh-sach-dich-vu-1 select#edit-field-dichvu-linhvuc-tid option[value="All"]'
//   ).attr("-Field-");
...
//   $(".i18n-en .view-id-danh_sach_dich_vu_1 th:nth-child(2)").text(
//     "Name of Laboratories"
//   );
//   $(
//     ".i18n-en .view-id-danh_sach_dich_vu_1 th.views-field-field-dichvu-chuquan"
//   ).text("Organization");
//   $(
//     ".i18n-en .view-id-danh_sach_dich_vu_1 th.views-field-field-dichvu-linhvuc"
//   ).text("Field");
//   $(
//     ".i18n-en .view-id-danh_sach_dich_vu_1 th.views-field-field-dichvu-khuvuc"
//   ).text("City");
//   $("#edit-sort-by").append(
//     '<option selected="selected" value="field_dichvu_khuvuc_tid">Sắp xếp</option>'
//   );
//   $(".view-danh-sach-dich-vu-1 .form-item-field-dichvu-vicas-value input").attr(
//     "placeholder",
//     "Số VICAS"
//   );
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 .form-item-field-dichvu-vicas-value input"
//   ).attr("placeholder", "VICAS");
//   $(".view-danh-sach-dich-vu-1 .form-item-field-dichvu-vias-value input").attr(
//     "placeholder",
//     "Số VIAS"
//   );
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 .form-item-field-dichvu-vias-value input"
//   ).attr("placeholder", "VIAS");
//   $(
//     ".view-danh-sach-dich-vu-1 .form-item-field-dichvu-vilas-med-value input"
//   ).attr("placeholder", "Số VILAS MED");
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 .form-item-field-dichvu-vilas-med-value input"
//   ).attr("placeholder", "VILAS MED");
//   $(
//     ".view-danh-sach-dich-vu-1 #edit_field_dichvu_linhvuc_tid_chosen input"
//   ).attr("value", "Lĩnh vực");
//   $(
//     ".view-danh-sach-dich-vu-1 #edit_field_dichvu_khuvuc_tid_chosen input"
//   ).attr({ value: "Tỉnh/TP", placeholder: "Tỉnh/TP" });
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 #edit_field_dichvu_linhvuc_tid_chosen input"
//   ).attr({ value: "Field", placeholder: "Field" });
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 #edit_field_dichvu_khuvuc_tid_chosen input"
//   ).attr({ value: "Province/City", placeholder: "Province/City" });
//   $(".region .region-sidebar-left").append('<div class="danhmuc"></div>');
//   $(".view-danh-sach-dich-vu-1 .view-header").insertAfter(
//     $(".view-danh-sach-dich-vu-1 #views-fieldset")
//   );
...
//   $(".i18n-en #dang-ky-fake #dangky_ms").attr(
//     "placeholder",
//     "Accreditation No"
//   );
//   $(".i18n-en #batdau").text("---Option---");
//   $("#edit-field-dichvu-khuvuc-tid-wrapper .ui-multiselect span")
//     .text("Tỉnh/Tp")
//     .css({ "padding-left": "4px", color: "#767676" });
//   $("#edit-field-dichvu-linhvuc-tid-wrapper .ui-multiselect span")
//     .text("Lĩnh vực")
//     .css({ "padding-left": "4px", color: "#767676" });
//   $(".i18n-en #edit-field-dichvu-khuvuc-tid-wrapper .ui-multiselect span")
//     .text("Province/City")
//     .css({ "padding-left": "4px", color: "#767676" });
//   $(".i18n-en #edit-field-dichvu-linhvuc-tid-wrapper .ui-multiselect span")
//     .text("Field")
//     .css({ "padding-left": "4px", color: "#767676" });
//   $(".i18n-en .view-danh-sach-bieu-mau th.views-field-nothing").text(
//     "Name Document"
//   );
...
//   $(
//     ".i18n-en .view-danh-sach-dich-vu-1 th.views-field-field-dichvu-diadiem"
//   ).text("Place");
//   $(".i18n-en #better-messages-wrapper .messages.sucess").text(
//     "Sucess Register"
//   );
//   $(".page-node-add-dang-ky.i18n-vi #page-title span").text(
//     "Đơn đăng ký công nhận"
//   );
//   $(
//     ".page-admin-structure-taxonomy-dich-vu-linh-vuc ul.action-links li a"
//   ).text("Thêm lĩnh vực");
//   //tvhoan 06-01-2017
...
//   $(
//     "#edit-field-dichvu-nhom-und-0-16-16,#edit-field-dichvu-nhom-und-0-15-15"
//   ).change(function() {
//     if (this.checked) {
...
//   $(
//     "#edit-field-dichvu-nhom-und-0-18-18,#edit-field-dichvu-nhom-und-0-17-17"
//   ).change(function() {
//     if (this.checked) {
...
//   $(
//     "#edit-field-dichvu-nhom-und-0-19-19,#edit-field-dichvu-nhom-und-0-20-20"
//   ).change(function() {
//     if (this.checked) {
...
//   $(
//     "#edit-field-dichvu-nhom-und-0-21-21,#edit-field-dichvu-nhom-und-0-22-22"
//   ).change(function() {
//     if (this.checked) {
...
//   $(
//     "#edit-field-dichvu-nhom-und-0-16-16,#edit-field-dichvu-nhom-und-0-15-15, #edit-field-dichvu-nhom-und-0-18-18,#edit-field-dichvu-nhom-und-0-17-17, #edit-field-dichvu-nhom-und-0-19-19,#edit-field-dichvu-nhom-und-0-20-20, #edit-field-dichvu-nhom-und-0-21-21,#edit-field-dichvu-nhom-und-0-22-22"
//   ).trigger("change");
